...
/**
 * @see http://snowball.tartarus.org/algorithms/portuguese/stemmer.html
 *
 * @author wamania
 */
class Portuguese extends Stem
{
     ...
     */
    protected static array $vowels = ['a', 'e', 'i', 'o', 'u', 'á', 'é', 'í', 'ó', 'ú', 'â', 'ê', 'ô'];
    ...
    public function stem(string $word): string
    {
        ...
        $this->word = UTF8::str_replace(['ã', 'õ'], ['a~', 'o~'], $this->word);
    ...
    private function step5()
    {
        ...
        if ($this->searchIfInRv(['e', 'é', 'ê']) !== false) {
            ...
            if (($position2 = $this->search(['gu', 'ci'])) !== false) {
    ...
    private function finish(): void
    {
        ...
        $this->word = UTF8::str_replace(['a~', 'o~'], ['ã', 'õ'], $this->word);
    }
}
